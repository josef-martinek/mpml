...
num_samp_list = [np.array([9, 2, 1]), np.array([20, 5, 1]), np.array([45, 11, 2]), np.array([112, 30, 6, 1])]
num_runs_per_tolerance = 1000
num_workers = 70

# Number of times to run the simulation
output_folder = "data/mpml_itref_fix_nsamp/"
this_file = "run_pml_fix_nsamp_statistics.py"
